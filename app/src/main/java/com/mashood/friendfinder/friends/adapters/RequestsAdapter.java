...
public class RequestsAdapter extends RecyclerView.Adapter<RequestsAdapter.MyViewHolder> {
    ...
    public interface ClickListener {
        void onAcceptClicked(FriendModel item);

        void onRejectClicked(FriendModel item);
    }

    public RequestsAdapter(Context c, ArrayList<FriendModel> data, ClickListener listener) {
        this.data = data;
        this.c = c;
